...
class TestNurseWorkflow:
    ...
    def test_add_patient(self, page: Page, app_url: str, test_patient_id: str):
    ...
    def test_full_nurse_workflow_single_video(
        ...
        expect(page.locator("#confirmPrescriptionModal")).to_be_visible()
        page.click("#confirmSubmissionBtn")
        expect(page.locator(".toast.success", has_text="prescription")).to_be_visible(
            timeout=10000
        )
...
class TestStatusSimulation:
    ...
    def test_complete_status_after_tracking(
        ...
        """Test that marking a medication as complete via tracking API changes the status to Complete (green)."""
